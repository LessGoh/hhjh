...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("""
        **🎓 Экспертиза:** Финансы и портфельное управление
        
        **🧠 ИИ:** GPT-4 с промптами на русском языке
        
        **📚 База знаний:** Научные статьи по волатильности
        
        **🔍 Анализ:** 12 релевантных источников
        
        **🇷🇺 Язык:** Подробные ответы на русском
        
        **📄 Формат:** Без отображения источников
        
        **🔒 Безопасность:** API ключи в Streamlit Secrets
        """)
